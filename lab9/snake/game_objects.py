...
class Food(GameObject):
    def __init__(self, occupied_points):
        ...
        self.weight = random.randint(1, 3)  # Генерируем случайный вес от 1 до 3
    
    def can_eat(self, point):
        return self.points[0].x == point.x and self.points[0].y == point.y
    ...
    def change_pos(self, occupied_points):
        ...
        self.weight = random.randint(1, 3)  # При смене позиции обновляем вес еды
